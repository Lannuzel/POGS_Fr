...
//            }
        ...
        // Mise à jour du ping à chaque message checkIn, quelle que soit la page
        Subject sender2 = subjectDao.getByExternalId(pogsMessage.getSender());
        if (sender2 != null) {
            subjectHasSessionCheckInService.updateLatestSubjectPing(sender2.getId(), sessionId);
        }
