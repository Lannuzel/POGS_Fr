...
class CanvasTextToImage {
    ...
    initAndDraw(){
        ...
        this.texts = [];
        //console.log("----Init_to_draw-------");
        for(var i = 0 ; i < this.textList.length; i ++){
            // Normalisation du texte pour éviter les problèmes d'encodage
            //this.textList[i].textContent = this.textList[i].textContent.normalize("NFC");
            this.textList[i].textContent = decodeURIComponent(escape(this.textList[i].textContent));
